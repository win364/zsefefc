            ...
            ! function() {
                ...
                i.prototype = {
                    ...
                    volume: function() {
                        ...
                        if (1 === r.length || 2 === r.length && "undefined" === typeof r[1] ? o._getSoundIds().indexOf(r[0]) >= 0 ? n = parseInt(r[0], 10) : e = parseFloat(r[0]) : r.length >= 2 && (e = parseFloat(r[0]), n = parseInt(r[1], 10)), !("undefined" !== typeof e && e >= 0 && e <= 1)) return (t = n ? o._soundById(n) : o._sounds[0]) ? t._volume : 0;
                        ...
                        for (var i = 0; i < n.length; i++)(t = o._soundById(n[i])) && (t._volume = e, r[2] || o._stopFade(n[i]), o._webAudio && t._node && !t._muted ? t._node.gain.setValueAtTime(e, a.ctx.currentTime) : t._node && !t._muted && (t._node.volume = e * a.volume()), o._emit("volume", t._id));
                        return o
                    },
                    ...
                    rate: function() {
                        ...
                        for (var i = 0; i < n.length; i++)
                            if (t = o._soundById(n[i])) {
                                o.playing(n[i]) && (t._rateSeek = o.seek(n[i]), t._playStart = o._webAudio ? a.ctx.currentTime : t._playStart), t._rate = e, o._webAudio && t._node && t._node.bufferSource ? t._node.bufferSource.playbackRate.setValueAtTime(e, a.ctx.currentTime) : t._node && (t._node.playbackRate = e);
                                var u = o.seek(n[i]),
                                    d = 1e3 * ((o._sprite[t._sprite][0] + o._sprite[t._sprite][1]) / 1e3 - u) / Math.abs(t._rate);
                                !o._endTimers[n[i]] && t._paused || (o._clearTimer(n[i]), o._endTimers[n[i]] = setTimeout(o._ended.bind(o, t), d)), o._emit("rate", t._id)
                            }
                        return o
                    },
                    seek: function() {
                        ...
                        if (0 === o.length) t._sounds.length && (n = t._sounds[0]._id);
                            ...
                            t._getSoundIds().indexOf(o[0]) >= 0 ? n = parseInt(o[0], 10) : t._sounds.length && (n = t._sounds[0]._id, e = parseFloat(o[0]))
                        ...
                        if (r) {
                            ...
                            var d = t.playing(n);
                            d && t.pause(n, !0), r._seek = e, r._ended = !1, t._clearTimer(n), t._webAudio || !r._node || isNaN(r._node.duration) || (r._node.currentTime = e);
                            var s = function() {
